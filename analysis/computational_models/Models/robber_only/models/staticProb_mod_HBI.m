...
%choosing the active choice. This model is for the robber task.
%
%parameters:
...
%noActValue = raw value of choosing the passive choice (ex for robber task = 0)
...
for i=1:N_stims_tot
    ...
    for t=1:stimTrialList(i)
        ...
        Q_A = -cost(k)+ subj_prob0.* offer(k); % value of active
