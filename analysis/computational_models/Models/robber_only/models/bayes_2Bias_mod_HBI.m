function [loglik] = bayes_2Bias_mod_HBI(parameters, subj)

%Bayesian learner model with a beta distributed prior and bidirectional bias.
...
for i=1:N_stims_tot
    ...
    for t=1:stimTrialList(i)
        ...
        Q_A = -cost(k)+ mu_subj.* offer(k); % value of passive
