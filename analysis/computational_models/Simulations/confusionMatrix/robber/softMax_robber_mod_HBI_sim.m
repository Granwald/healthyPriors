function [act,success, Q_action] = softMax_robber_mod_HBI_sim(parameters, offers, noActValues, costs, winprobs, stimTrialList)
...
for i=1:length(stimTrialList)
    ...
    for t=1:stimTrialList(i)
        ...
        Q_A = -cost(k) + offer(k); % value of fighting (action)
